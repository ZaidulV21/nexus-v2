        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-7" noValidate>
          ...
          <section className="space-y-4">
            ...
            <FormField
              ...
              hint="Full detail-page copy. Blank lines separate overview paragraphs."
            >
              <Textarea
                id="sub-description"
                rows={5}
                placeholder="Everything this option covers. Use blank lines between paragraphs."
          ...
          {/* ── Display ───────────────────────────────────────────── */}
          <section className="space-y-4">
            <h3 className="text-sm font-semibold uppercase tracking-wider text-ink-faint">Display</h3>
            <div className="grid gap-4 sm:grid-cols-2">
