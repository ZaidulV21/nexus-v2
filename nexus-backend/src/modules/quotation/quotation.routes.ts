...
router.get('/me', authenticate, quotationController.listForClient);
router.get('/me/:id', authenticate, quotationController.getForClient);
...
router.post('/:id/request-revision', authenticate, quotationController.requestRevision);
